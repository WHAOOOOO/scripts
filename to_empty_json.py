#  根据图片生成一个不含annotations的json空标注文件
import os
import cv2
import json
import glob
...
_classes = ('__background__',  # always index 0
            'holothurian', 'echinus', 'starfish', 'scallop', 'waterweeds')

data_list = '/Users/wanghao/Desktop/ocean/test_A/test.txt'  # train, val or test txt, No suffix
img_path = '/Users/wanghao/Desktop/ocean/test_A/image/'  # image folder path
# xml_path = '/Users/wanghao/Desktop/Tianchi_bottle/xml/'  # xml folder path
save_json_path = '/Users/wanghao/Desktop/ocean/test_A/test_A.json'  # name for save json
